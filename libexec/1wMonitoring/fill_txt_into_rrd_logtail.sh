...
# This is useful if the rrd database does not get updated automatically but the
# values are fed into it continuously by a cron script. In that case this would
# be the initial readout of the file by logtail
#
